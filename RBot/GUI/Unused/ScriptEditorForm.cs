...
namespace RBot
{
    public partial class ScriptEditorForm : HideForm
    {
        ...
        private void TabsEditors_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            {
                EditorTab tab = tabsEditors.TabPages.Cast<EditorTab>().Where((_, i) => tabsEditors.GetTabRect(i).Contains(e.Location)).FirstOrDefault();
                if (tab != null)
                {
        ...
        private void openToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (ofd.ShowDialog() == DialogResult.OK)
            {
                ...
                EditorTab tab = tabsEditors.TabPages.Cast<EditorTab>().FirstOrDefault(x => x.FileName == full);
                if (tab == null)
                {
                    tab = new EditorTab();
                    tab.Load(full);

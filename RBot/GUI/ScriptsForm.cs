...
namespace RBot
{
    public partial class ScriptsForm : HideForm
    {
        ...
        private void btnEditScript_Click(object sender, EventArgs e)
        {
            ...
            {
                var scripteditor = Path.Combine(Environment.CurrentDirectory, "editor", "ScriptEditor.exe");
                Process.Start(scripteditor);
            }
        }
        ...
        private void btnOpenScriptsFolder_Click(object sender, EventArgs e)
        {
            var scriptsfolder = Path.Combine(Environment.CurrentDirectory, "Scripts");
            Process.Start(scriptsfolder);
        }
    }
}
